  ...
  <Reveal>
    <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
      <div>
        ...
        <h3 className="mt-3 max-w-3xl font-display text-3xl font-semibold tracking-tight text-earth-deep sm:text-4xl lg:text-5xl">
      ...
      <div className="hidden shrink-0 items-center gap-3 rounded-full border border-primary/15 bg-primary/[0.04] px-4 py-2.5 text-xs font-semibold uppercase tracking-[0.15em] text-earth md:flex">
  ...
  <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    {company.team.map((member, index) => (
      ...
      >
        <article
          className="
            group relative h-full min-h-[360px]
            overflow-hidden rounded-[1.5rem]
            border border-[#ead8c2]
            bg-[#fffaf3]
            p-6
            shadow-[0_10px_30px_rgba(45,25,10,0.07)]
            transition-all duration-500
            hover:-translate-y-2
            hover:border-primary/40
            hover:bg-white
            hover:shadow-[0_24px_55px_rgba(45,25,10,0.15)]
          "
        >
          {/* Decorative glow */}
          <div
            ...
            <div className="flex justify-center">
              <div
                className="
                  ...
                  bg-[#f3e5d3]
                  shadow-[0_8px_25px_rgba(80,45,20,0.12)]
                  ring-1 ring-primary/20
                  transition-all duration-500
                  group-hover:scale-105
                  group-hover:ring-primary/40
                  group-hover:shadow-[0_12px_35px_rgba(80,45,20,0.18)]
                "
              >
                {member.image ? (
                  <img
                  ...
                  <div className="grid h-full w-full place-items-center">
                    <span className="font-display text-xl font-bold text-earth">
                      {member.name
                        .split(" ")
                        .filter(Boolean)
                        .slice(0, 2)
            ...
            <div className="mt-7 text-center">
              ...
              <h4
                className="
                  ...
                  tracking-tight text-earth-deep
                  transition-colors duration-300
                  group-hover:text-primary
                "
              >
