          ...
          <Reveal>
            <div className="h-full rounded-2xl border border-border bg-background p-8 shadow-[var(--shadow-card)] lg:p-10">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                For departments, companies, research bodies and NGOs.
                A technical lead responds within one working day.
              </p>
          ...
          <Reveal delay={0.08}>
            ...
            >
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                ...
                Cohorts open every month across our technology tracks.
              </p>
